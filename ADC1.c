...
void ADC_y_Init(void){ // ADC0, PB24
...
uint32_t ADC_y_in(void){ // ADC0, PB24
...
// sample 12-bit ADC
void ADC_InDual(ADC12_Regs *adc12,int32_t *d1, int32_t *d2){
...
uint32_t Convert(uint32_t input){
  int32_t k1 = 1001;// 1776; 
  int32_t k2 = 0; // 8; 
  uint32_t result = ((k1*input) >> 12) - k2; 
  // Position = ((1663*input)>>12) + 192;
