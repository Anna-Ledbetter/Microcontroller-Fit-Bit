...
IOMUX->SECCFG.PINCM[PB0INDEX] = (uint32_t) 0x00000081; // GPIO output 
IOMUX->SECCFG.PINCM[PB1INDEX] = (uint32_t) 0x00000081; // GPIO output 
IOMUX->SECCFG.PINCM[PB2INDEX] = (uint32_t) 0x00000081; // GPIO output
IOMUX->SECCFG.PINCM[PB3INDEX] = (uint32_t) 0x00000081; // GPIO output 
IOMUX->SECCFG.PINCM[PB4INDEX] = (uint32_t) 0x00000081; // GPIO output 
